...
public class AllProcessController {
    ...
    public void work() throws InterruptedException, TelegramApiException {
        ...
        telegramDataStoreModel = new TelegramDataStoreModel("CaptchaSlove_bot", "6102830132:AAGzv3fN_k8YdITpHkOyjqtsDQfWqviF398", sendMessage);
        ...
        if (textCSVModel.isFlag()) {
            ...
            if (dataStoreModel.getArrayList_Char().size() == 1) {
                ...
                lessOrEqual4000CharControllerForThread1.changeFileNameWithDriver(dataStoreModel, dataStoreModelForNewDriver01.getParams());
                ...
                lessOrEqual4000CharControllerForThread2.changeFileNameWithDriver(dataStoreModel, dataStoreModelForNewDriver02.getParams());
